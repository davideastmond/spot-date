<template>
  <div class="mt-16 mb-16">
    <div class="mb-8">
      <p class="largeHeroTitle text-center lg:text-start">Latest albums on Spotify</p>
      <p class="heroSubtitle text-gray-400 text-center lg:text-start">What's hot and who's listening?</p>
    </div>
    <div class="lg:ml-[20%] lg:mr-[20%]">
      <!-- Container for album renderings -->
      <div class="bg-spotty-deep-brown rounded-md p-4 shadow-xl flex lg:justify-evenly flex-col lg:flex-row">
